...
<input type="hidden"  name="password" value="{{ Auth::user()->password }}" readonly>
  ...
  <div class="form-group">
    ...
    <input type="occupation" class="form-control mt-0" name="occupation" value="{{Auth::user()->occupation}}" readonly>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea rows="5" type="self_introduction" class="form-control mt-0" name="self_introduction" readonly>{{Auth::user()->self_introduction}}</textarea>
  </div>
  </div>
